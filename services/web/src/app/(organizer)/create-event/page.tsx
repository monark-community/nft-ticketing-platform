    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <nav className="bg-[#3a7bd5] px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <a href="#" className="text-white/80 text-sm font-semibold border-b-2 border-white pb-0.5">Create Event</a>
          <div className="flex items-center gap-2 bg-white/20 rounded-full px-3 py-1">
            <span className="text-white text-sm font-mono">"Wallet address"</span>
