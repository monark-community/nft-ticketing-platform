...
export interface TicketNFTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "maxResalePrice",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface TicketNFT extends BaseContract {
  ...
  SCANNER_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  checkInTicket: TypedContractMethod<
    [tokenId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  isUsed: TypedContractMethod<[arg0: BigNumberish], [boolean], "view">;

  maxResalePrice: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  tokenEventId: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "maxResalePrice"
